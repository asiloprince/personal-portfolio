...
function AboutMe() {
  ...
  const educationDetails = [
    ...
    <div className="education-screen-container" key="interests">
      ...
      <EducationHeading
        heading="Technology"
        description="I want to be a person who can always catch up with the latest technology and respond to changes."
      />
      <EducationHeading
        heading="Design"
    ...
    <div>
        ...
        <Card.Body className="card-body">
          ...
          <Card.Text>
            <section className="overview">
              <i className="fas fa-code mr-5"></i> I have built 5 projects since
              2020.
            </section>
            <section className="overview">
              {" "}
              <i className="fas fa-graduation-cap"></i> I am a Second year IT
              Student at Batangas State University.
            </section>
            <section className="overview">
              {" "}
              <i className="fab fa-dev"></i> I am an aspiring full-stack
              developer.
            </section>
            <section className="overview">
              {" "}
              <i className="fas fa-exclamation-circle"></i> I do not have any
              job experience yet.
            </section>
          </Card.Text>
        </Card.Body>
      ...
      <div className="aboutme-container">
        ...
        <div className="about-text">
          ...
          <p>
            {" "}
            I am Prince Gerald Asilo, Second year IT student at Batangas State
            University.
          </p>
          <p>
            {" "}
      ...
      <div className="education-container">
        ...
        <div className="education-content">
          <div className="education-card">
            ...
            <div className="education-bullet-details">
              {getEducationScreens()}
            </div>
          </div>
        </div>
